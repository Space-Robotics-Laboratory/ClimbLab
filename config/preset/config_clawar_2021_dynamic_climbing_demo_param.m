%%%%%% Configuration
%%%%%% config_clawar_2021_dynamic_climbing_demo_param
%%%%%% 
...
function [robot_param, environment_param, gait_planning_param, control_param, equilibrium_eval_param, ani_settings, save_settings, ...
    plot_settings] = config_clawar_2021_dynamic_climbing_demo_param(robot_param, environment_param, gait_planning_param, control_param, ...
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Gait Parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Gait type ('do_nothing', 'crawl_fixed_stride','periodic_gait_for_discrete_footholds','nonperiodic_gait_for_discrete_footholds' )
...
ani_settings.camera_az =-15;
ani_settings.camera_el = 5;

%%% Font name
ani_settings.font_name = 'Times New Roman';
%%% Font size
ani_settings.font_size = 18;
...
ani_settings.force_expansion_factor = 0.002;
    ...
    ani_settings.reaction_force_show = 'on';
        ...
        ani_settings.reaction_force_vec_color = [1 0 1];
