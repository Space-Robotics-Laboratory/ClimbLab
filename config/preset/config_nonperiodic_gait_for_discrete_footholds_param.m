%%%%%% Configuration
%%%%%% config_nonperiodic_gait_for_discrete_footholds_param
%%%%%% 
%%%%%% Define parameters for the nonperiodic swing limb selection demonstration
%%%%%% 
%%%%%% Created 2020-09-10
%%%%%% Kentaro Uno
...
%
%
% Load configurations for parameters defined for the nonperiodic gait for discrete
...
function [robot_param, environment_param, gait_planning_param, control_param, equilibrium_eval_param, ani_settings, save_settings, ...
    plot_settings] = config_nonperiodic_gait_for_discrete_footholds_param(robot_param, environment_param, gait_planning_param, control_param, ...
...
environment_param.surface_type = 'flat_006';
...
%%% Goal position [m]
gait_planning_param.goal = [0.3;0.2;0.0];
%%% Allowable maximum stride [m]
gait_planning_param.allowable_max_stride = 0.15; 
...
ani_settings.acceleration_expansion_factor = 0.04;
    ...
    ani_settings.gravitational_acceleration_vec_show = 'on';
        ...
        ani_settings.gravitational_acceleration_vec_color = [0.7 0 0];
