%%%%%% Update
%%%%%% upd_base_traject_spline3_one_segment_time
%%%%%% 
...
function [motion_planning_param, gait_planning_param] = upd_base_traject_spline3_one_segment_time(gait_planning_param, motion_planning_param, time, LP)
...
% Define new trajectory for base
    ...
    if rem(time, gait_planning_param.T) < d_time
        ...
        if gait_planning_param.swing_number == gait_planning_param.sequence(1) ... 
            ...
            || strcmp(gait_planning_param.type,'crawl_gait_for_discrete_footholds') ... 
