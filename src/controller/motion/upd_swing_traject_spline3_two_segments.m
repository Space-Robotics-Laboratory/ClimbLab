...
function [motion_planning_param, gait_planning_param] = upd_swing_traject_spline3_two_segments(gait_planning_param, motion_planning_param, des_SV, LP)
...
% Define new trajectory for swing leg
	...
	if sum(des_SV.sup) == LP.num_limb
		...
		xm_dd = [ 0; 0; 0 ];
		t_m = 0.5*(gait_planning_param.leg_T(1) + gait_planning_param.leg_T(2));
