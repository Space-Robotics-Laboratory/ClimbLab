...
classDiagram
  ...
  class LimbTrajectory {
    ...
    + orientation: EEOrientationTrajectory

    + initialize()
    + plan()
    + update()
  }
  LimbTrajectory *-- EEPositionTrajectory
  LimbTrajectory *-- EEOrientationTrajectory

  class EEPositionTrajectory {
    + planner:
  ...
  EEPositionTrajectory *-- TrajectoryPlanner
  EEPositionTrajectory *-- Trajectory
