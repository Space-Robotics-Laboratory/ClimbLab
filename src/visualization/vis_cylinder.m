...
%%%%%% vis_cylinder
%%%%%% 
%%%%%% isualize the cylinder connect any two points X1 and X2
%%%%%% 
%%%%%% Created: 2021-01-19
%%%%%% by Warley Ribeiro
...
% ------------------------------------------------------------------------
% J. Divahar (2021). Cylinder (https://www.mathworks.com/matlabcentral/fileexchange/13995-cylinder), MATLAB Central File Exchange. Retrieved January 19, 2021.
% ------------------------------------------------------------------------
%
