...
%         -
%     INPUT
%         gait_planning_param.goal      : Position vector of goal
...
function vis_goal(gait_planning_param, inc, ani_settings)
if strcmp(ani_settings.goal_show,'on')
    ...
    goal = rpy2dc([0;pi*inc/180;0]) * [gait_planning_param.goal(1,:); 
                                       gait_planning_param.goal(2,:); 
                                       gait_planning_param.goal(3,:) + ani_settings.goal_vis_height];
