...
% Trajectory Planning
motion_planning = motion_planning.plan(time, robot, foothold_planning, gait_planning);

% Limb Controller
robot = limb_controller.control(time, robot, foothold_planning, gait_planning, motion_planning, ...
  terrain);
